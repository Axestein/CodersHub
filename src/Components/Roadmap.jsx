...
const Roadmap = () => {
  ...
  // Data for each box
  const boxData = [
    { title: 'Frontend', description: 'A Frontend Developer creates the visual and interactive elements of websites and apps.', links: ['https://drive.google.com/file/d/1NZ2JURtTNxn5zMnboZV_26h3Hc-Th3St/view?usp=sharing', 'Frontend Resources Link', 'Frontend YouTube Link', 'Frontend Get Certified Link'] },
    { title: 'Backend', description: 'A Backend Developer builds and maintains the server-side logic, databases, and APIs.', links: ['https://drive.google.com/file/d/1ka-1z8fM4VtNFrTTn5OMNk7_dnwqOCKU/view?usp=sharing', 'Backend Resources Link', 'Backend YouTube Link', 'Backend Get Certified Link'] },
