    ...
    <>
      ...
      <footer className="bg-black text-white py-8 px-4 relative">
        ...
        <div className="hidden md:block max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8 text-right">
            {/* Home Section */}
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                <li><a href="#discord" className="hover:text-purple-400">Discord</a></li>
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><a href="#hackathons" className="hover:text-purple-400">UI/UX</a></li>
              </ul>
            </div>
